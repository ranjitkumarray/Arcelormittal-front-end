    ...
    router.events.pipe(
      ...
      if (this.url[2] === 'base-price') {
        ...
        if (this.url[3] === 'mini-bar') {
          ...
          this.displayedColumns = ['BusinessCode', 'Market_Country', 'Product_Level_04', 'Product_Level_05', 'Product_Level_02', 'Delivering Mill', 'Document_Item_Currency', 'Customer Group', 'Market_Customer', 'Amount', 'Currency',]
        } else {
